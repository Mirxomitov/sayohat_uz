...
import 'package:lesson3/lesson4/detail.dart';
import 'package:lesson3/lesson4/intro.dart';
import 'package:lesson3/lesson5/lesson5.dart';
import 'package:lesson3/test/lesson4.dart';

import 'hello.dart';
import 'lesson4/home.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const fontSecondary = Color(0xffD6D2D2);
    ...
    return MaterialApp(
      ...
      /*const SizedBox(
        ...
        child: ItemLocation(
          data: ItemData(
            imagePath: 'assets/info/germany.png',
            title: 'Frankfurt',
            location: 'Germany',
            description: 'Germany is clear',
            rate: 4.5,
          ),
        ),
      ),*/
